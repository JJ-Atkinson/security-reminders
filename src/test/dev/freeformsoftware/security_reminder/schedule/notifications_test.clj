...
(deftest test-format-correction-sms
  (testing "rescind message"
    (let [msg (reminders/format-correction-sms :rescinded "Alice" "Wed Evening" "2026-04-01" "https://example.com/tok/schedule")]
      (is (re-find #"no longer assigned" msg))
      (is (re-find #"Wed Evening" msg))))
  (testing "assign message"
    (let [msg (reminders/format-correction-sms :assigned "Bob" "Sun Morning" "2026-04-05" "https://example.com/tok/schedule")]
